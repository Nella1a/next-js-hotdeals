...
const Deals = async () => {
  ...
  return (
    <>
      <h1 className="h-32 max-w-screen-lg mx-auto  my-12 flex flex-col justify-center items-center text-xl font-semibold sm:flex-row mt-40 bg-white shadow-md">
      ...
      <section className="max-w-screen-lg mx-auto justify-center items-center grid gap-4 md:grid-cols-3 px-4">
